...
var NotaryContainer = React.createClass({
  render: function () {
    return (
      ...
      <div className="row">
        ...
        <div className="col-md-6 preview-container">
          <div className="preview">
            <Note title="Static Note">
              ### Hello!
              This is some _static_ text.
            </Note>
          </div>
        </div>
      </div>
...
React.renderComponent( <NotaryContainer />, document.getElementById('content'));
